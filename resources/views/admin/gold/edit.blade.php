        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Edit Gold-Weight</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{route('gold-update')}}">
                                @csrf
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="number" name="rate"
                                            ...
                                            placeholder="Enter Gold Rate" value="{{$data->rate}}"/>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="submit" class="btn btn-primary px-4" value="Update Gold Rate" />
                                    </div>
                                </div>
                        </div>
